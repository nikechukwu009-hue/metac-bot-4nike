...
This repository contains a simple bot meant to get you started with creating your own bot for the AI Forecasting Tournament. This version is configured for conservative, calibrated forecasts and uses OpenRouter Claude Sonnet 4.6 for forecasting, parser, and summarizer roles, with OpenRouter Perplexity Sonar Pro as a dedicated research model running parallel prompt passes. Go to https://www.metaculus.com/aib/ for more info and tournament rules (and then go to the  "Getting Started" section of our [resources](https://www.metaculus.com/notebooks/38928/ai-benchmark-resources/#want-to-join-the-ai-forecasting-benchmark) page).
