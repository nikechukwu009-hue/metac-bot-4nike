...
This repository contains a simple bot meant to get you started with creating your own bot for the AI Forecasting Tournament. This version is configured for evidence-based forecasts and uses OpenRouter Claude Sonnet 4.6 as the main committee model; parser and summarizer also use the same model by default. OpenRouter Perplexity Sonar Pro is used as a dedicated research model running parallel prompt passes. Go to https://www.metaculus.com/aib/ for more info and tournament rules (and then go to the  "Getting Started" section of our [resources](https://www.metaculus.com/notebooks/38928/ai-benchmark-resources/#want-to-join-the-ai-forecasting-benchmark) page).
